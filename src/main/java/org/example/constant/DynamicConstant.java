...
public class DynamicConstant {
     ...
     * 动态发布后，评论数量为0
     */
    public static final Integer DEFAULT_DYNAMIC_COMMENT_COUNT = 0 ;

    /**
     * 动态分页查询，默认当前页最小值是1
     */
    public static final Integer DEFAULT_NOW_PAGE_MIN_PAGE = 1 ;
     ...
     * 消息通知分页查询，默认当前页最小值是1
     */
    public static final Integer Inform_DEFAULT_NOW_PAGE_MIN_PAGE = 1 ;

    /**
     * 评论分页查询，默认当前页大小最小值是1
     */
    public static final Integer Inform_DEFAULT_PAGE_SIZE_MIN_VALUE = 1 ;

    /**
     * 默认分页查询评论数量最小数量为0
     */
    public static final Integer Inform_DEFALUT_DYNAMIC_COUNT_MIN_VALUE = 1 ;
